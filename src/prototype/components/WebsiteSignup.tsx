...
function EmailBox({ email, setEmail, onSend, onClose }: { email: string; setEmail: (v: string) => void; onSend: () => void; onClose: () => void }) {
    ...
    <div className="ws-page">
      ...
      {popup !== "none" && (
        <div className="ws-backdrop">
          ...
          {popup === "email" && <EmailBox email={email} setEmail={setEmail} onSend={() => setPopup("otp")} onClose={close} />}
          {popup === "otp" && (
            <CodeBox

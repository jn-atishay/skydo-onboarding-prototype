const MultiUsersIcon = ({ stroke, containerClass }: { stroke: string; containerClass?: string }) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className={containerClass}>
      <path

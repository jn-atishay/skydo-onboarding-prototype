...
const RawOtpInput = React.forwardRef<OtpInputRef, OTPInputProps>(
  (props: OTPInputProps, ref: ForwardedRef<OtpInputRef>) => {
    const {
      value = "",
      numInputs = 4,
      onChange,
    ...
    useImperativeHandle(ref, () => ({
      focus: (number) => focusInput(number),
    }));
...
RawOtpInput.displayName = "RawOtpInput";

export type { OTPInputProps, InputProps, AllowedInputTypes };
export default RawOtpInput;
